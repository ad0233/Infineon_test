...
| 3V3（数字） | DC-DC | **U5 主控模组（JC-ESP32P4-M3）**、**U6 协处理器模组（OA-W01 / ESP32-C6）**、雷达 SPI 数字侧、麦克风、传感器、状态 LED |
...
1. **U17 功放 HTA8998** — 满载 4–5 W 热
2. **U5 主控模组（JC-ESP32P4-M3）** — 雷达 SPI 25 MHz + 多任务时偏高
3. **U6 协处理器模组（OA-W01 / ESP32-C6）** — Wi-Fi 满载发射时偏高
4. **U12 DC-DC（SY8368QNC）** — 全负载时温升明显
