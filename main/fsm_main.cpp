...
static struct StateTable fsm_user_table[] = {
    ...
    //TODO:测试  改成长按播放动画
    { fm_has_movement_state     ,FM_H_F_FAI             ,F_MAIN_E_ANIM_PLAY_SUC              , F_MAIN_S_MENU_UNWIND       , F_MAIN_S_MENU_UNWIND ,0    ,false       , fsm_main_in_unwind},//歌曲切换--歌曲切换
    { fm_has_movement_state     ,FM_H_F_SUC             ,F_MAIN_E_ANIM_PLAY_SUC              , F_MAIN_S_MENU_UNWIND       , F_MAIN_S_MENU_UNWIND_PLAYING ,0    ,false       , fsm_main_memu_cat_playing},//歌曲切换---动画
    ...
    {nullptr             ,0                     , F_MAIN_E_BTN_CLICKED   ,F_MAIN_S_SLEEPMODE                   ,F_MAIN_S_SLEEPMODE_READY     ,0  ,false    ,  fsm_main_in_sleep_mode_ready},//提醒--入睡提示dome
