...
#define PIN_XENSIV_BGT60TRXX_SPI_SCLK       GPIO_NUM_23 //
#define PIN_XENSIV_BGT60TRXX_SPI_MOSI       GPIO_NUM_21 //
#define PIN_XENSIV_BGT60TRXX_SPI_MISO       GPIO_NUM_20 //
#define PIN_XENSIV_BGT60TRXX_SPI_CSN        GPIO_NUM_12 //
/* sensor interrupt output pin */
#define PIN_XENSIV_BGT60TRXX_IRQ            GPIO_NUM_22 //
/* sensor HW reset pin */
