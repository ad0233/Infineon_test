...
static const char *s_client_cert = NULL;
static const char *s_client_key = NULL;
...
static void mqtt_app_start(void)
{
    ...
    esp_mqtt_client_config_t mqtt_cfg = {
        .broker = {
            ...
            .verification.certificate = s_server_cert
        },
        .credentials = {
            .client_id = my_ble_get_mac(false),
            .authentication = {
...
void my_mqtt_init(const char* broker_uri, const char* server_cert, const char* client_cert, const char* client_key)
{
    ...
    s_server_cert = server_cert;
    s_client_cert = client_cert;
