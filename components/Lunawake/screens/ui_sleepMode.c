...
void ui_sleepMode_screen_init(void)
{
    ...
    lv_obj_set_x(ui_sleepModeHour, -55);
    ...
    lv_obj_set_style_text_font(ui_sleepModeHour, &ui_font_roboto72, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_sleepModeMinute, 55);
    ...
    lv_obj_set_style_text_font(ui_sleepModeMinute, &ui_font_roboto72, LV_PART_MAIN | LV_STATE_DEFAULT);
