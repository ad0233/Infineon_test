...
- **主控方案**：P4 + C6 双芯架构。U5 = JC-ESP32P4-M3 主控模组（P4 + 16 MB Flash + 8 MB PSRAM）；U6 = OA-W01 协处理器模组（ESP32-C6 + 天线，提供 **Wi-Fi 6 / 2.4 G + BLE 5 + 802.15.4 Thread**，走 `esp_hosted` 透传）。详见 [doc/hardware/networking.md](doc/hardware/networking.md)。
